...
export const ExclamationTriangle = ({ className, title }: IconProps) => {
  const defaultTitle = "exclamation-triangle-icon";
  return (
    <svg
      width="24"
      height="24"
